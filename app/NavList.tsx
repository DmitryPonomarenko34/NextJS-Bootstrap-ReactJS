...
export default function NavList() {
  ...
  return (
    <nav className="bg-xl-danger order-first order-xl-0 position-xl-absolute top-100 start-0 width-xl-100 h-auto z-index-100">
      <div className="container">
        ...
        <ul
          ...
          } opacity-0 z-index-100 transtition-transform -translate-y-300 translate-xl-0 opacity-xl-100 start-0 w-100 top-menu top-sm-menu top-lg-menu top-xl-0 w-xl-auto bg-danger ps-xl-3 position-absolute position-xl-static bg-xl-none list-unstyled nav-list d-block d-xl-flex mb-0`}
        >
